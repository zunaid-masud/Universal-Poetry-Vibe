...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="relative overflow-hidden pt-8 pb-16 md:pt-14 md:pb-24 border-b border-[#d4af37]/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            ...
            {/* Feature Highlights */}
            <div className="pt-4 grid grid-cols-3 gap-3 max-w-md mx-auto lg:mx-0 border-t border-[#2d1e18] text-center">
              <div className="p-2">
                <span className="block text-lg sm:text-xl font-serif font-bold text-[#dfb76c]">
                  ১০০+
                </span>
                <span className="text-[11px] text-[#a39380] font-bengali-sans">
                  ভিন্টেজ ডিজাইন
                </span>
              </div>
          ...
          <div className="lg:col-span-6 relative flex flex-col items-center">
            ...
            <div className="relative w-full max-w-lg transition-transform duration-700 ease-out hover:scale-[1.02]">
              ...
              <div className="mt-4 flex items-center justify-between bg-[#150e0b]/90 backdrop-blur-md border border-[#d4af37]/30 rounded-xl p-2.5 shadow-lg">
